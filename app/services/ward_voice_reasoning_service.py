        ...
        "observations": {
            ...
            "items": {
                ...
                "properties": {
                    "observation_type": {
                        "type": "string",
                        "enum": ["systolic_bp", "diastolic_bp", "temperature", "pulse", "spo2", "urine_output", "oral_intake", "vomit", "drainage", "note"],
                    },
...
Do not infer, calculate, normalize, diagnose, or fill missing fields. Use ml for fluid volumes,
mmHg for blood pressure, C for temperature, /min for pulse, and % for SpO2 when those values
are explicitly present. Mark clinically unusual values or confidence below 0.85 as requiring
